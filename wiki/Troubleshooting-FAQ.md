...
Short **symptom → checks** guide. For release-accurate API and flag lists, use the [README](https://github.com/shomanjk/esp32_balboa_spa/blob/main/README.md).
...
- [RS485 5-minute diagnostic checklist](https://github.com/shomanjk/esp32_balboa_spa/blob/main/docs/rs485-5min-diagnostic-checklist.md)
...
4. **`GET /api/wifi`** — JSON mirror of station state (see [README JSON APIs](https://github.com/shomanjk/esp32_balboa_spa/blob/main/README.md#json-api-get)).

If the device stays offline long enough, firmware may self-restart (see `WIFI_OFFLINE_RESTART_*` comments in [`config-example.h`](https://github.com/shomanjk/esp32_balboa_spa/blob/main/src/config-example.h)).
...
4. **Temperature unit** — Default discovery uses **°F**. Celsius tubs: set `MQTT_HA_TEMP_UNIT` in `config.h` (see [config-example.h](https://github.com/shomanjk/esp32_balboa_spa/blob/main/src/config-example.h)).
...
Canonical topic and entity list: [README — MQTT and Home Assistant](https://github.com/shomanjk/esp32_balboa_spa/blob/main/README.md#mqtt-and-home-assistant).
...
- [Command-write debug log](https://github.com/shomanjk/esp32_balboa_spa/blob/main/docs/command-write-debug-log.md) (maintainer ledger)
...
Full runbook: [OTA_LOGGING_WORKFLOW.md](https://github.com/shomanjk/esp32_balboa_spa/blob/main/OTA_LOGGING_WORKFLOW.md).
...
- For HA `configuration_url`, use a DHCP reservation and local DNS if needed (see [README](https://github.com/shomanjk/esp32_balboa_spa/blob/main/README.md#mqtt-and-home-assistant)).
